    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if filas_hoy:
                ...
                # Buscamos todas las filas de la tabla para saber cuál es el fondo real de la página

                todas_las_filas = page.query_selector_all("table.tt tr")

               

                # Tu lógica original: el inicio es el primer vuelo de hoy

                # Pero el fin lo obligamos a ser el último elemento real de la tabla para que no se coma nada

                target_rows = [filas_hoy[0], todas_las_filas[-1]] if todas_las_filas else [filas_hoy[0], filas_hoy[-1]]
